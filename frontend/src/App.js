...
//           {/* Navbar */}
//           <nav className="flex justify-between items-center bg-black p-4 fixed top-0 w-full z-10">
...
const App = () => {
  ...
  // Cache random books in localStorage to reduce API call
  ...
  return (
    <UserContext.Provider value={{ userId, handleLogin }}>
      <Router>
      <div className="min-h-screen bg-gray-100 flex flex-col justify-between bg-gradient-to-r from-yellow-200 via-orange-200 to-yellow-100">
  {/* Navbar */}
  <nav className="flex justify-between items-center bg-black p-4 fixed top-0 w-full z-10">
    ...
    {/* Navigation Links aligned to the left side */}
    <div className="flex text-white space-x-4 items-center ml-8">
      ...
      <Link to="/best-selling-books" className="hover:text-yellow-500 transition">Best Selling Books</Link>
      <Link to="/popular" className="hover:text-yellow-500 transition">Popular Books</Link>
      <Link to="/books-read" className="hover:text-yellow-500 transition">Books Read</Link>
      <Link to="/auth" className="hover:text-yellow-500 transition">
        <img 
              ...
              <Route
                ...
                element={
                  <div className="flex-grow flex flex-col justify-center items-center text-center">
                    ...
                    <div className="flex items-center justify-center w-full px-4 mt-16">
                      ...
                      <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
                        {(bookResults.length > 0 ? bookResults : randomBooks).map((book) => (
                          <li key={book.key}  className="bg-white p-4 shadow-lg rounded-lg cursor-pointer hover:shadow-2xl hover:translate-y-[-4px] transition-transform duration-200">
                            ...
                            <button
                              className="mt-4 bg-blue-500 hover:bg-blue-300 text-white font-bold py-2 px-4 rounded transform transition-transform duration-200 hover:scale-105"
                              onClick={() => handleBookClick(book)}
                            >
                              Save Book
                            </button>
                            <button
                              className="mt-4 ml-4 bg-green-500 hover:bg-green-300 text-white font-bold py-2 px-4 rounded transform transition-transform duration-200 hover:scale-105"
                              onClick={() => handleReadMore(book.key)}
                            >
                              Read Me
                            </button>
        ...
        <footer className="bg-black text-white py-5 px-4 text-center">
       <p className="text-lg">
